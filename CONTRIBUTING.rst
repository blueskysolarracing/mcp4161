...
Thanks for considering contributing to MCP4161! Your contributions are
greatly appreciated, and help make MCP4161 a better tool for everyone in
the computer engineering community.

Setting up Your Development Environment
---------------------------------------

1. Fork the MCP4161 repository on GitHub.
2. Clone your fork locally: ``git clone git@github.com:username/mcp4161.git``
...
1. Run static type checking with ``--strict`` flag: ``mypy --strict mcp4161``
2. Run style checking: ``flake8 mcp4161``
3. Run unit tests: ``python -m unittest``
4. Run doctests: ``python -m doctest mcp4161/*.py``
...
3. Submit a pull request to the ``main`` branch in the MCP4161 repository.
